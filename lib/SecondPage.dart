...
//this page is about the water footprint calculator
void main() {
  runApp(SecondPageWidget());
}

class SecondPageWidget extends StatefulWidget {
  @override
  _SecondPageWidget createState() => _SecondPageWidget();
}

class _SecondPageWidget extends State<SecondPageWidget> {
